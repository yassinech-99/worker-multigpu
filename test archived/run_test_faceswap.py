#!/usr/bin/env python3
"""
Runpod Serverless Endpoint Test Script for Face Swap - Flux Kontext Place It Lora
This script sends a request to your deployed Runpod serverless endpoint using the testinput_faceswap.json file.
"""
...
def main():
    ...
    print("🧪 Runpod Face Swap - Flux Kontext Place It Lora Endpoint Tester")
    print("=" * 60)
    ...
    # Configuration
    test_input_file = Path(__file__).parent / "testinput_faceswap.json"
