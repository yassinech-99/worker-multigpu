#!/usr/bin/env python3
"""
Runpod Serverless Endpoint Test Script for Face Swap - Flux ACE++
This script sends a request to your deployed Runpod serverless endpoint using the testinput_faceswap_ace.json file.
"""
...
def main():
    ...
    print("🧪 Runpod Face Swap - Flux ACE++ Endpoint Tester")
    print("=" * 50)
    ...
    # Configuration
    test_input_file = Path(__file__).parent / "testinput_faceswap_ace.json"
